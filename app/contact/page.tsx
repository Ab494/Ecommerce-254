                ...
                <div className="mt-8 space-y-6">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-muted-foreground">sales@254convexcomltd.co.ke</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-muted-foreground">Jeevan Bharat Building 5th Flr along Harambee Avenue, Nairobi</p>
                    </div>
                  </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      <div className="grid gap-6 sm:grid-cols-2">
                        <div className="space-y-2">
                          ...
                          <Input id="firstName" placeholder="Vanso" required />
                        </div>
                        <div className="space-y-2">
